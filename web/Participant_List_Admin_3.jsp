    ...
    <body style="background-color: #bcbcbc">
        ...
        <center>
            ...
            <div style="width: 970px;height: 450px;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;float: right;height: 450px;overflow-x:scroll;">
                    <center>
                        <%
                            int idd=Integer.parseInt(request.getParameter("id"));
                             District dd=District.getDistrict_Distrinct_ID(idd);
                            %>
                            <h3><a href="District_Participant_Report.jsp?id=<%=dd.getDistrict() %>">All Participants Of<%= " " + dd.getName()%></a></h3>
                ${p.msg}
                ${pz.msg}
                <br>
                    ...
                    <tbody>
                        ...
                        <td style="background-color: yellow"><%=no%></td>
                            ...
                            <td style="background-color: yellow"><a href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=yellow&st=district">View</a></td>
                        ...
                        %>
                            ...
                            <td ><a  style="background-color: white;color: green" href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=green&st=myct&fcolor=white">View</a></td>
                            <td><a href="Option_Status_1.jsp?id=<%=l.get(i).getId()%>&op=center">Send To Center</a></td>
                             <td><a href="Option_Status_1.jsp?id=<%=l.get(i).getId()%>&op=rejected">Reject</a></td>
                        ...
                        <td style="background-color: skyblue;color: black"><%=no%></td>
                            ...
                            <td style="background-color: skyblue;color: black"><%=l.get(i).getMarital_status()%></td>
                             ...
                             <td style="background-color: skyblue;color: black"><a href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=skyblue&st=center">View</a></td>
                            <td><a href="Option_Status_1.jsp?id=<%=l.get(i).getId()%>&op=center">Send To Center</a></td>
                             <td><a href="Option_Status_1.jsp?id=<%=l.get(i).getId()%>&op=rejected">Reject</a></td>
                        ...
                        %>
                            ...
                            <td style="background-color: khaki;color: black"><a href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=khaki&st=graduated">View</a></td>
                        ...
                        <%
                            ...
                            <td style="background-color: red;color: white"><a href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=khaki&st=graduated">View</a></td>
