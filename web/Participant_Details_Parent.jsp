                    ...
                    <table border="1" class="" style="width: 2300px">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: <%=color %>;color:<%=fore_color %> ">
                                ...
                                <td style="background-color: #cccccc;color: black"><a href="Case_Form_Parent.jsp?id=<%=l.get(i).getId()%>&op=myct">Record(s)</a></td>
                                <td style="background-color: #cccccc;color: black"><a href="Skill_Form_Parent.jsp?id=<%=l.get(i).getId()%>&op=myct">Record(s)</a></td>
