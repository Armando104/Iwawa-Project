                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 250px;"> 
                                                <p><%="  You have (" + Participant.get_Count_district("district", u.getRef_id()+"") + ")"%></p>                         <img src="Photos/staff.png" width="112" height="112" alt="staff" style="margin-top: -20px;"/>                             <p> New Registered</p> 

                                            </td>
                                            <td style="width: 250px;"> 
                                                <p><%="  You have (" + Participant.get_Count_district("myct", u.getRef_id()+"") + ")"%></p>                         <img src="Photos/staff.png" width="112" height="112" alt="staff" style="margin-top: -20px;"/>                             <p>Pending In MYCT</p> 

                                            </td>
                                                <td style="width: 250px;"> 
                                                <p><%="  You have (" + Participant.get_Count_district("center", u.getRef_id()+"") + ")"%></p>                         <img src="Photos/staff.png" width="112" height="112" alt="staff" style="margin-top: -20px;"/>                             <p>Current Participants in Center</p> 

                                            </td>
                                                 <td style="width: 250px;"> 
                                                <p><%="  You have (" + Participant.get_Count_district("center", u.getRef_id()+"") + ")"%></p>                         <img src="Photos/staff.png" width="112" height="112" alt="staff" style="margin-top: -20px;"/>                             <p>Graduated from Center</p> 
