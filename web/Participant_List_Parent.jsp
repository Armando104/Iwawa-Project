            ...
            <div style="width: 970px;height: 450px;overflow-y: scroll;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                        ...
                        <h3>Your Request Acceptance(s) At Iwawa Center</h3>
                        <h5>Khaki Color:Graduated.....Red Color:Rejected..Green:Pending At MYICT..Skyblue Color:Accepted At Center</h5>
                    ...
                    <tbody>
                        <%
                            ...
                            for (int i = 0; i < l.size(); i++) {
                               if(l.get(i).getDistrict_id()==u.getUser_id()){
                                %>
                                 <tr>
                                <%
                        ...
                        %>
                            ...
                            <td ><a  style="background-color: white;color: green" href="Participant_Details_Parent.jsp?id=<%=l.get(i).getId()%>&color=green&st=myct&fcolor=white">View</a></td>
                        ...
                        <td style="background-color: skyblue;color: black"><%=no%></td>
                            ...
                            <td style="background-color: skyblue;color: black"><%=l.get(i).getMarital_status()%></td>
                             ...
                             <td style="background-color: skyblue;color: black"><a href="Participant_Details_Parent.jsp?id=<%=l.get(i).getId()%>&color=skyblue&st=center">View</a></td>
