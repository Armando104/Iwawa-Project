                    ...
                    <center>
                        ...
                        <%
                            if(request.getParameter("op").equalsIgnoreCase("myct")){
                             %>
                             <h3><a target="_blank" href="Report_Pending_List_1.jsp?op=myct"><%="PENDING REQUESTS LIST" %></a></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("graduated")){
                            %>
                            <h3><a target="_blank" href="Report_Pending_List_1.jsp?op=graduated"><%=request.getParameter("op").toUpperCase()+" REQUESTS LIST" %></a></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("rejected")){
                            %>
                            <h3><a target="_blank"  href="Report_Pending_List_1.jsp?op=rejected"><%=request.getParameter("op").toUpperCase()+" REQUESTS LIST" %></a></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("center")){
                            %>
                            <h3><a target="_blank" href="Report_Pending_List_1.jsp?op=center"><%="ACCEPTED REQUESTS LIST"%></a></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("district")){
                            %>
                            <h3><a target="_blank" href="Report_Pending_List_1.jsp?op=district"><%="NEW REGISTRATIONS LIST"%></a></h3>
                            <%
                            }
                            %>
                    ...
                    <tbody>
                        <%
                            ...
                            for (int i = 0; i < l.size(); i++) {
                                 if(l.get(i).getDistrict_id()==u.getRef_id()){
                        ...
                        <td style="background-color: yellow"><%=no%></td>
                            ...
                            <td style="background-color: khaki;color: black"><a target="_blank" href="Personnal_Report_1.jsp?id=<%=l.get(i).getId()%>&color=khaki&st=graduated">Report</a></td>
