        ...
        <center>
            ...
            <div style="width: 970px;height: 470px;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                 <p>New District Saving Form</p>
            
                <br><br>
                ${p.msg}
                <form action="District_Processing.jsp">
                    <table border="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="hidden" name="district" value="${p.district}" /></td>
                            </tr>
                            <tr>
                                <td>Province</td>
                                <td>
                                    ...
                                    <%
                                          List<Province>ll=Province.getList();
                                           for(int i=0;i<ll.size();i++){
                                               
                                             %>
                                             <option value="<%=ll.get(i).getProvince_id()%>"><%=ll.get(i).getName() %></option>
                                             <%
                                           }
                                           %>
