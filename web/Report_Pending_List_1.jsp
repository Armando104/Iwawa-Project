...
<%        }
District ds=District.getDistrict_Distrinct_ID(u.getRef_id());
            ...
            <div id="ds" style="width: 95%;height: auto;background-color: white;color: black;border: 0px #000 solid">
                ...
                <div style="width: 100%;height: auto;margin-top: 0px;border:  3px black solid;border-radius: 0px;background-color: whitesmoke">
                 ...
                 if(request.getParameter("op").equalsIgnoreCase("district")){
                             %>
                             <h3><%="NEW REGISTRATIONS LIST IN "+ds.getName().toUpperCase() %></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("myct")){
                             %>
                             <h3><%="PENDING REQUESTS LIST IN "+ds.getName().toUpperCase() %></h3>
                            <%
                            }
                            if(request.getParameter("op").equalsIgnoreCase("graduated")){
                            %>
                             <h3><%=request.getParameter("op").toUpperCase()+" REQUESTS LIST IN "+ds.getName().toUpperCase() %></h3>
                            <%
                            }
                            ...
                            %>
                             <h3><%="ACCEPTED REQUESTS LIST IN "+ds.getName().toUpperCase() %></h3>
                            <%
                            }
                            %>
                    ...
                    <tbody>
                        <%
                            ...
                            for (int i = 0; i < l.size(); i++) {
                                if(l.get(i).getDistrict_id()==u.getRef_id()&&l.get(i).getStatus().equalsIgnoreCase(request.getParameter("op"))){
                                %>
                                 <tr>
                                <%
