...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background-color: #bcbcbc">
        ...
        <center>
            ...
            <div >
                <br></br>  <h3>New Training Registration Form</h3><br></br>
                ${p.msg}
                <form action="Training_Processing.jsp">
                    <table border="0">
                        
                     
                        <tbody>
                            <tr>
                                <td style="color: black">Training Title</td>
                                <td><input type="text" name="title" value="${p.title}" required=""/></td>
                                <td></td>
                            </tr>
                              <tr>
                                <td>Reward</td>
                                <td><input type="text" name="reward" value="${p.reward}" required=""/></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>Year</td>
                                <td><input type="text" name="year" value="${p.year}" required=""/></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
