                ...
                <table border="1" class="table table-striped" id='sample_1' >
                    ...
                    <tbody>
                        ...
                        <td style="background-color: yellow"><%=no%></td>
                            ...
                            <td><a href="Option_Participant.jsp?id=<%=l.get(i).getId()%>&op=Edit"><img src="a.imgs/edit-icon.png" width="30" height="30" alt="edit-icon"/>
                                     </a></td>
                                 <td><a href="Option_Participant.jsp?id=<%=l.get(i).getId()%>&op=Delete"><img src="a.imgs/Delete_Icon.png" width="30" height="30" alt="Delete_Icon"/>
                                     </a></td>
