    ...
    <body style="background-color: #bcbcbc">
        ...
        <center>
            ...
            <div style="width: 970px;height: 470px;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <h3> Training To Be Given</h3>
           
                <h5><a href="Training_Form.jsp">Click Here to Add New Training</a></h5>
                ${p.msg}
                <table border="1" class="table table-bordered" id='sample_1'>
                    ...
                    <tbody>
                        <%
                            int no=1;
                            List<Training>l=Training.getList();
                            for(int i=0;i<l.size();i++){
                            %>
                        <tr>
                            <td><%=no %></td>
                            <td><%=l.get(i).getTitle()%></td>
                             <td><%=l.get(i).getReward()%></td>
                             <td><a href="Training_Participant_List.jsp?id=<%=l.get(i).getTraining_id()%>">View</a></td>
                            </tr>
                        <%
                            no++;
                            }
