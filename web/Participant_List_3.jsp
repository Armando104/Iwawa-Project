            ...
            <div style="width: 970px;height: 450px;overflow-y: scroll;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                        ...
                        <h3>All Current Participants At Center</h3>
                ${p.msg}
                ${pz.msg}
                <br>
                    ...
                    <tbody>
                        ...
                        <td style="background-color: skyblue;color: black"><%=no%></td>
                            ...
                            <td style="background-color: skyblue"><a href="Participant_Details_1.jsp?id=<%=l.get(i).getId()%>&color=skyblue&st=district">View</a></td>
                            <td style="background-color: skyblue"><a href="Set_Graduation.jsp?id=<%=l.get(i).getId()%>&color=skyblue&st=district">Yes</a></td>
