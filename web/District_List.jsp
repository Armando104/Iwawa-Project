            ...
            <div style="width: 970px;height: 500px;background:url(images/banner-bg.jpg) no-repeat center;overflow: scroll">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                        ...
                        <h3>Registered Districts</h3>
                        <h5><a href="District_Form.jsp">Click Here to Add New District</a></h5>
                        ${p.msg}
                <table border="1" class="table table-bordered" id='sample_1'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=Province.getProvince_ID(l.get(i).getProvince_id()).getName()   %></td>
                            <%
                                 User  x=User.getUser_Ref(l.get(i).getDistrict()+"");
                                 if(x!=null){
                                 %>
                                  <td><%=x.getNames()%></td>
                                 ...
                                 %>
                                 <td style="background-color: yellow;color: black"><a href="User_Form.jsp?n=<%=l.get(i).getName()%>">Add User</a></td>
                           
                                 <%
                                 }
                                 %>
                                 <td><a href="Participant_List_Admin_3.jsp?id=<%=l.get(i).getDistrict()%>">View</a></td>
                       
                        
                                 <td><a href="Option_District.jsp?id=<%=l.get(i).getDistrict()%>&op=Edit"><img src="a.imgs/edit-icon.png" width="30" height="30" alt="edit-icon"/>
                                     </a></td>
                                 <td><a href="Option_District.jsp?id=<%=l.get(i).getDistrict()%>&op=Delete"><img src="a.imgs/Delete_Icon.png" width="30" height="30" alt="Delete_Icon"/>
                                     </a></td>
