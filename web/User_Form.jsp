                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><input type="hidden" name="role" value="district" readonly=""/></td>
                            </tr>
                              <tr>
                                <td>Password</td>
                             ...
                             <tr>
                                <td>District</td>
                                <%
                                    District ds=District.getDistrict_Name(request.getParameter("n"));
                                    %>
                                   <td><input type="text" name=""  value="<%=ds.getName() %>" readonly=""/></td>
                                   <td><input type="hidden" name="ref_id" placeholder="<%=ds.getName() %>" value="<%=ds.getDistrict()%>" hidden=""/></td>
