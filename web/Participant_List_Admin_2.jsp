            ...
            <div style="width: 970px;height: 450px;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;float: right;height: 450px;overflow-x:scroll;">
                    <center>
                        ...
                        <h3>All Parents Acceptance(s) At Iwawa Center Requests</h3>
                        <h6>Khaki:Graduated - Red:Rejected - Yellow:Pending At District - Green:Pending At Center - Skyblue:Accepted At Center</h6>
                
                ${p.msg}
                ${pz.msg}
                <br>
                    <table border="1" class="table table-striped" id='sample_1' style="width: 1300px">
                    <thead>
                        <tr>
                            <th>No</th>
                             <th>ID</th>
                    ...
                    <tbody>
                        <%
                            ...
                            if(l.get(i).getRequested_by().equalsIgnoreCase("parents")){
