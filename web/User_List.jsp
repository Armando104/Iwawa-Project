        ...
        <center>
            ...
            <div style="width: 970px;height: 450px;overflow-y: scroll;background:url(images/banner-bg.jpg) no-repeat center;">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                  <h3>Registered System Users List</h3>
       
               
                 ${p.msg}
                 <b><a href="User_Form_1.jsp">Add New Center's User</a></h3></b>
                        ...
                        <tr>
                            ...
                            <td><%=l.get(i).getNames() %></td>
                              <td><%=l.get(i).getUsername()%></td>
                                ...
                                <%
                                   if(l.get(i).getRole().equalsIgnoreCase("district")){
                                   %>
                                   <td><%=District.getDistrict_Distrinct_ID(l.get(i).getRef_id()).getName()   %></td>
                            
                                   <%
                                   }else{
                                         if(l.get(i).getRole().equalsIgnoreCase("center")){
                                              %>
                                   <td>Iwawa</td>
