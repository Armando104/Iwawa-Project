        ...
        <center>
            ...
            <div style="width: 970px;height: 470px;background:url(images/banner-bg.jpg) no-repeat center;">
             ...
             <%
                    ...
                    Training ppp = Training.getCase_ID(Integer.parseInt(id));
                %>            
                <h3><%=" " + ppp.getTitle() + "'s Participants"%></h3>
                    ...
                    <tbody>
                        <%
                            ...
                            for (int i = 0; i < l.size(); i++) {
                                System.out.println("ID:" + l.get(i).getTraining_id()+" ID:"+ppp.getId());
                                if (l.get(i).getTraining_id() == ppp.getTraining_id()) {
                                    Participant tr = Participant.getParticipant_From_ID(l.get(i).getParticipant_id()+"");
                                    {
                                     %>
                        <tr>
                            <td><%=no%></td>
                            ...
                            <td><%=tr.getNames()%></td>
                            <%
                                        if(l.get(i).getPerformance().equalsIgnoreCase("")){
                                        %>
                                        <td><a href="Set_Performance.jsp?op=Excellent&id=<%=l.get(i).getPart_training_id()%>">Excellent</a></td>
                                        <td><a href="Set_Performance.jsp?op=Good&id=<%=l.get(i).getPart_training_id()%>">Good</a></td>
                                        <td><a href="Set_Performance.jsp?op=Fail&id=<%=l.get(i).getPart_training_id()%>">Fail</a></td>
