        ...
        <div class="header">
            <div class="row">
                ...
                <div style="width: auto;float: left">
                    <center>
                        <h1 style="color: chartreuse">Ministry Of ICT and Youth</h1>
                        <h3 style="color: chartreuse">IWAWA Rehabilitation Center</h3>
                     </center>
                </div>
        ...
        <center>
            ...
            <div style="width: 970px;height: 300px;background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <img src="images/rwanda_640.png" width="640" height="480" alt="rwanda_640" style="height: 300px;width: 400px;"/>
                ...
                <div class="left-panel" style="width: 100%">
                    <div class="panel">
                        <div class="title">
                            ...
                            <center>
                                <h1 style="text-align: left">Online Rehabilitation and Vocational Skills Development Center Management System</h1>
                            </center>
                        </div>
